...
export const AdminLayoutRoutes: Routes = [
    ...
    { path: 'ips/en-campo', component: IpEnCampoComponent, canActivate : [AuthGuardSecurity],  data: { expectedRole: 'ROLE_IPS_EN_CAMPO' }  },
    { path: 'reporte-ip', component: RptEjecutivoIpComponent, canActivate : [AuthGuardSecurity],  data: { expectedRole: 'ROLE_RPT_IP_SEMANA' }   },
    { path: 'configuracion', component: ConfReporteComponent , canActivate: [AuthGuardSecurity],  data: { expectedRole: 'ROLE_CONFIGURACIONES' }},
