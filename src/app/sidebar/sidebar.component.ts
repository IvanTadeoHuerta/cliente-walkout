...
export const ROUTES: RouteInfo[] = [
  ...
  { path: '/reporte-ip', title: 'Reporte IP', icon: 'pe-7s-note2', class: '', roles: ['ROLE_RPT_IP_SEMANA'] }, //Change role
  ...
  { path: '/ips/en-campo', title: 'IP´s en campo', icon: 'pe-7s-photo', class: '', roles: ['ROLE_IPS_EN_CAMPO'] },
  { path: '/configuracion', title: 'Configuracion', icon: 'pe-7s-settings', class: '', roles: ['ROLE_CONFIGURACIONES'] }
];
