        ...
        this.service.createIp(this.ip).subscribe(result => {
          ...
          if (result.successful) {
            ...
            if(this.ip.tipo == 1){
               ...
               mensaje = 'IP registrada';

            }else{

              mensaje = 'Feeder registrado';
            ...
            swal.fire({ 
            title: mensaje, 
            text: ' Se registró: '+ this.ip.ip, 
            type: 'success',
            confirmButtonText: "Registrar otr@",
            cancelButtonText: "No",
            ...
            allowOutsideClick: false,
              ...
              if (!result.dismiss) {
                ...
                this.submitted = false;
                this.create = true;
                this.ip = new Ip(-1, '', 0.0, '', new Date(),  this.auth.getUserid(), -1, true, 1, new Proyecto(-1, '', '', true), [], new Date());
                this.ip.proyecto.id_proyecto = parseInt(this._route.snapshot.paramMap.get('id_proyecto'));
                this.form.controls.ip.reset();
                this.form.controls.ubicacion.reset();
