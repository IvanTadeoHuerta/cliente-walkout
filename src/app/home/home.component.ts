...
export class HomeComponent implements OnInit, OnDestroy {
  ...
  public rolCliente: boolean = false;


  constructor(private service: HomeService, private auth: AuthService, private router: Router) {}
  ...
  ngOnInit() {
    ...
    this.graficas = [];
    this.rolCliente= this.auth.hasPermission('ROLE_CLIENTE');;
    ...
    if(!this.rolCliente){
      ...
      this.router.navigate(['reporte-ip']);
            ...
            if (result.successful) {
              ...
              setTimeout(() => {
                ...
                this.graficas.forEach((el, index) => {
                  ...
                  el[1].fecha_inicio = datePipe.transform( el[1].fecha_inicio , 'mediumDate');
                  el[1].fecha_fin = datePipe.transform( el[1].fecha_fin , 'mediumDate');
                  // Fin formato dia
