...
export class IpComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.permisos.crear = this.auth.hasPermission('ROLE_CREAR_IP');
    this.permisos.editar = this.auth.hasPermission('ROLE_EDITAR_IP');
    this.permisos.eliminar = this.auth.hasPermission('ROLE_ELIMINAR_IP');
    this.permisos.changeStatus = this.auth.hasPermission('ROLE_ESTATUS_IP');
    this.permisos.enviarCampo = this.auth.hasPermission('ROLE_ENVIO_A_CAMPO');
    this.permisos.recibidoQC = this.auth.hasPermission('ROLE_RECIBIDO_QC');
    this.permisos.enviarCliente = this.auth.hasPermission('ROLE_ENVIAR_CLIENTE');
    this.permisos.rechazoCliente = this.auth.hasPermission('ROLE_RECHAZO_CLIENTE');
    this.permisos.upSharedPoint = this.auth.hasPermission('ROLE_UP_SHAREDPOINT');
